...
const modeDisk = civilMemoryKV.disk.name?.replace('KV', '')
const modeHttp = civilMemoryKV.http.name?.replace('KV', '')
const modeVolatile = civilMemoryKV.volatile.name?.replace('KV', '')
